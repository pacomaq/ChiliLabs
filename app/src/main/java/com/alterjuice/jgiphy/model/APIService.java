...
public interface APIService {
    ...
    Call<SearchTrendingResponse> searchGif(
            @Query(Consts.keyParamApiKey) String apiKey,
    ...
    Call<SearchTrendingResponse> searchGif(
            ...
            @Query(Consts.keyParamOffset) Integer offset,
            @Query(Consts.keyParamLimit) Integer limit,
            @Query(Consts.keyParamRating) String rating,
            @Query(Consts.keyParamLanguage) String lang,
    ...
    @GET(Consts.TREND_URL)
    Call<SearchTrendingResponse> getTrends(
            @Query(Consts.keyParamApiKey) String apiKey,
            @Query(Consts.keyParamOffset) Integer offset
    );
